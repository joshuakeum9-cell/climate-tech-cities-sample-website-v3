        ...
        orgs: [
          {
            ...
            body: "The UCL Energy Institute, within the Bartlett, researches energy demand, buildings, modeling, and shipping. It is a research and teaching institute, not a founder accelerator or fund. Founders route to UCL Business for spinouts and IP and to UCL Innovation & Enterprise for general startup support. Suits founders wanting a research or talent partner, not venture support.",
          },
          {
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Founders Factory is a London venture studio and accelerator running sector-focused, often corporate-backed programs, with climate and energy a current focus. Its climate track invests capital for minority equity and pairs founders with in-house operators across product, growth, PR, fundraising, and talent, plus access to corporate partners for pilots and commercial contracts. Programmes run roughly six months, squad-based. Suits pre-seed and seed founders with scalable tech and early traction who want hands-on operational build support and corporate access.",
          },
          {
            name: "Climate-KIC (UK)",
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Clean Growth Fund is a London-based, UK-only climate VC investing at seed and Series A in companies with clear emissions-reduction potential across power, transport, industrial decarbonization, buildings, agrifood, and circular economy. Beyond capital it offers founder-friendly support and a close partnership with an incubator for commercialization and business development. It is genuinely London-headquartered with a UK-only mandate. Suits early-stage UK cleantech founders with measurable carbon impact.",
          },
        ],
        photoBreakAfter: true,
      },
      ...
      },
      {
        orgs: [
          ...
          },
          {
            ...
            type: "Venture capital",
            focus: "Climate & industrial tech",
            body: "Speedinvest is a pan-European early-stage VC with a dedicated climate and industrial-tech team covering energy, infrastructure, construction, manufacturing, mobility, and decarbonization, plus a growth follow-on vehicle. Beyond capital it offers an in-house operational team for growth, hiring, and US expansion, plus a large founder network. It has a genuine London office alongside other European hubs. Suits pre-seed and seed European climate and industrial-tech founders wanting hands-on operational support.",
          },
          {
            name: "Ada Ventures",
      ...
      },
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Counteract is a London VC billed as the first dedicated carbon-removal fund, investing at pre-seed and seed across all removal pathways, from direct air capture and biochar to mineralization, enhanced weathering, and carbon-removing concrete. Beyond capital it offers deep removal specialty, with a threshold that each company plausibly enables large-scale removal. It is genuinely London-based. Suits carbon-removal founders at the earliest stages.",
          },
          {
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            type: "Corporate VC",
            focus: "Clean energy",
            body: "PERSEO is the international startup program of utility Iberdrola, whose US subsidiary is Avangrid, offering founders equity investment, strategic alliances, innovation challenges, and pilot projects, with a venture builder based mainly in Spain. Focus spans electrification, decarbonization, EV charging, solar, offshore wind, and industrial heat, and its Massachusetts nexus runs through Avangrid's US challenges and offshore-wind interests. It is a global program without a dedicated local venture office. Suits energy startups, especially in offshore wind and grid, seeking utility pilots and European market access.",
          },
          {
    ...
    groups: [
      {
        ...
        orgs: [
          ...
          },
          {
            ...
            type: "School",
            focus: "Sustainability, climate, energy",
            body: "Stanford's Doerr School of Sustainability is a university school, not a dedicated founder program, and the academic hub for its climate and sustainability research. Founders should target its Sustainability Accelerator, which funds and helps commercialize solutions, and Stanford's broader entrepreneurship arms like StartX. Its direct value is research, talent, and translational funding rather than a cohort. Suits Stanford researchers seeking research funding and translational support before incorporation.",
          },
          {
        ...
        orgs: [
          {
            ...
            type: "University Accelerator",
            focus: "Tech incl. climate",
            body: "USC's Viterbi Startup Garage is a university accelerator in Marina del Rey running a one-year residency for early-stage technology startups, now taking no equity and no fees with founders keeping all IP. Founders get around-the-clock coworking space, innovator-in-residence coaching, specialist mentors from the USC network, workshops, a speaker series, and investor introductions, with a national commercialization partnership. It is sector-agnostic, including climate hardware and software. Suits USC-connected, post-ideation technical founders wanting free space and hands-on coaching.",
          },
          {
      ...
      },
      {
        orgs: [
          ...
          },
          {
            ...
            type: "Corporate VC",
            focus: "Low-carbon energy",
            body: "Chevron Technology Ventures is Chevron's corporate strategic VC, headquartered in Houston rather than LA, investing through a core fund for its own operations and a future-energy fund for transition technology like carbon capture, hydrogen, storage, industrial decarbonization, and emerging mobility, typically at Series A through C. Its distinctive value is access to Chevron's industrial assets and facilities for piloting and a scale-up and partnership pathway. Suits later-stage-of-early climate and energy founders seeking an industrial strategic partner and pilot sites, listed as a Houston source rather than a first-check provider.",
          },
        ],
      },
    ],
        ...
        orgs: [
          {
            ...
            body: "Howard University's Environmental and Climate Justice Center sits in its law school and focuses on environmental-justice scholarship, education, and advocacy, serving communities and nonprofits rather than for-profit founders. Its value is legal and policy expertise and community support rather than venture programming. Mission-aligned founders route to Halcyon, which prioritizes equity-driven entrepreneurs. Suits environmental-justice advocates and community organizations, with Halcyon as the founder door.",
          },
        ],
      },
      {
        ...
        orgs: [
          ...
          },
          {
            ...
            body: "The University of Maryland's Center for Global Sustainability is a research and policy center delivering emissions-pathway analysis and policy engagement, not a startup program. Its value to founders is research and policy insight rather than capital or acceleration. Founders route to MEI2 and MEIA for commercialization. Suits policy researchers, with the Maryland energy programs as the founder doors.",
          },
          {
        ...
        orgs: [
          {
            ...
            body: "UC San Diego's von Liebig Center is a proof-of-concept center commercializing university inventions through pre-seed grants, business mentoring, and entrepreneurial education, rather than an open-application accelerator. It provides technology-advancement and customer-validation grants and a network of technology and business advisors who guide researchers through commercialization milestones, with much current activity delivered through the Institute for the Global Entrepreneur. Suits UC San Diego faculty, researchers, or students with lab IP needing early validation funding and commercialization coaching.",
          },
        ],
      },
      {
        ...
        orgs: [
          {
            ...
            type: "State Agency",
            focus: "Energy R&D & policy",
            body: "The California Energy Commission is the state's energy policy, planning, and clean-energy R&D funding agency, and for founders its value is non-dilutive grant funding and credibility delivered through its clean-energy R&D program rather than a direct accelerator. Founders apply to its adjacent vehicles, chiefly CalSEED for early grants, CalTestBed for testing vouchers, and SCEIN as the San Diego regional cluster, plus follow-on and scale-up programs. Suits California clean-energy founders seeking non-dilutive capital and testing and commercialization support through the programs it funds.",
          },
          {
            name: "CalSEED",
            url: "https://calseed.fund/",
          ...
          },
          {
            ...
            type: "Public program (CEC)",
            focus: "Clean energy",
            body: "BlueTechValley is a state-funded clean-energy, water, and agriculture innovation cluster centered on Fresno State and covering Central and Northern California, offering an accelerator, technology evaluation, proof-of-concept validation, field-testing sites, and commercialization services. It is a Central Valley cluster rather than a San Diego program, and San Diego blue-economy founders should instead use the regional maritime cluster and UC San Diego's startBlue. Suits energy, water, and agtech founders in the Central and Northern California footprint, with startBlue as the San Diego equivalent.",
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        orgs: [
          ...
          },
          {
            ...
            type: "Graduate research program",
            focus: "Clean energy research",
            body: "The PNNL and WSU Distinguished Graduate Research Program is a doctoral training pipeline embedding WSU students in lab research in their later years, funded by their advisors, not a founder program with startup services. Its value to founders is technical talent and research collaboration. Founders route to the WSU Office of Commercialization for licensing and venture development. Suits doctoral students, with the commercialization office as the founder door.",
          },
          {
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            focus: "Cleantech ecosystem",
            body: "CleanTech Alliance is a regional cleantech industry association with a large multi-state membership, not itself an accelerator, offering founders networking events, policy advocacy, industry clusters, commercialization assistance, a diversity fund, and co-running the Cascadia accelerator. Its value is ecosystem visibility, connections, and policy engagement, with the dedicated early-stage program to enter being Cascadia. Suits any Pacific Northwest cleantech founder wanting ecosystem visibility and connections, with Cascadia as the founder door.",
          },
          {
        ...
        orgs: [
          {
            ...
            body: "Polsky Deep Tech Ventures is the University of Chicago's umbrella for turning hard science into companies, run out of the Polsky Center in Hyde Park. It pairs technology licensing and venture formation with a stack of sector accelerators, and it draws on an unusual research catchment covering the university, Argonne National Laboratory, and Fermilab. Founders enter through one of its named programs rather than the umbrella itself. Suits scientists and engineers with defensible technology who need a licensing path and a first cohort.",
          },
          {
            ...
            body: "Resurgence is the cleantech accelerator inside Polsky Deep Tech Ventures, built with the Pritzker School of Molecular Engineering and supported by Invenergy. It works with early clean-energy teams on the particular difficulty of commercializing materials and energy science, moving from customer discovery through investor readiness with mentors drawn from the university, the national laboratories, and the region's energy operators. Suits early clean-energy founders coming out of a lab who want structured commercialization support.",
          },
          {
            ...
            body: "Compass is Polsky's deep-tech accelerator for the earliest stage, aimed at teams still shaping a technology into a venture rather than scaling one. It provides structured curriculum, mentorship, and a route into the wider Deep Tech Ventures network of accelerators, investors, and licensing support. Suits pre-company scientists and engineers who need a first structured push.",
          },
          {
            ...
            body: "Transform is Polsky's data science and artificial intelligence accelerator, and it is not climate-dedicated, though climate and environment companies are explicitly eligible. Selected teams receive funding, curriculum, and mentorship modelled on Polsky's quantum accelerator, plus introductions to investors working in applied AI. Climate founders whose wedge is software and data fit better here than hardware founders, who should look at Resurgence. Suits climate software and data founders comfortable in an AI-first cohort.",
          },
          {
        ...
        orgs: [
          {
            ...
            body: "The Technology Innovation Lab is UIC's incubator in the Illinois Medical District, and unusually for a university facility it is open to founders with no UIC affiliation alongside faculty, students, and staff. It offers wet and dry laboratory bench space as well as co-working, which matters for water, materials, and environmental sensing companies that need a sink and a fume hood rather than a desk. Suits early hardware and laboratory-based founders who need affordable bench space inside the city.",
          },
          {
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            type: "Accelerator",
            focus: "Deep tech incl. cleantech",
            body: "Alchemist Chicago is the Chicago edition of the Alchemist accelerator, launched with the Polsky Center and open to founders with no university affiliation as well as those inside it. It concentrates on enterprise and deep-tech companies, cleantech included, and puts selected teams through Alchemist's sales-led curriculum before a demo day in front of its investor network. Suits deep-tech and cleantech founders selling to enterprises who need distribution discipline and investor exposure.",
          },
          {
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Current is Chicago's water innovation hub, and it leads the federally funded regional engine building a circular water economy across the Great Lakes states. For founders that means pilots with utilities and industrial water users, research partnerships across a multistate coalition, accelerator programming run with mHUB, and the convening power of Chicago Water Week. It is a nonprofit intermediary rather than an investor. Suits water technology founders who need real testbeds and utility customers.",
          },
          {
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Constellation is the Chicago-headquartered clean-energy generator spun out of Exelon and the largest operator of nuclear generation in the country, which makes it a natural counterparty for founders working on clean firm power, load flexibility, and grid services. It does not run a standing open startup program, and its startup-facing engagement has come through sponsoring accelerator cohorts and evaluating technologies for pilots, so founders should approach through mHUB rather than looking for an application form. Suits grid, load, and clean firm power founders looking for a large offtaker and pilot host.",
          },
          {
        ...
        orgs: [
          {
            ...
            body: "Impact Engine is a Chicago firm built entirely around investing for measurable social and environmental returns, with climate among its core themes alongside economic opportunity and health. It invests across venture and private equity, holds companies to reported impact outcomes, and has been part of the Chicago scene long enough to be a useful door into the city's family-office and philanthropic capital. Suits climate founders who can evidence impact outcomes and want an investor fluent in that language.",
          },
          {
          ...
          },
          {
            ...
            body: "Sandbox Industries builds venture funds alongside corporate strategic partners, and its sustainability and food and agriculture investing runs through Cultivian Sandbox Ventures. The corporate backing is the point, because it turns a funding conversation into a route to commercial validation and distribution with large industry players. It invests from seed through growth. Suits sustainability and agrifood founders who need corporate channels as much as capital.",
          },
          {
          ...
          },
          {
            ...
            body: "Bluestein Ventures invests across the food value chain from its office in the Loop, at seed through Series A, with sustainability as one of its stated pillars alongside nutrition and digitization. Its portfolio runs from alternative protein through supply chain software, which reflects Chicago's position at the center of North American food and agriculture. Suits early-stage food systems founders whose product reduces the footprint of how food is grown, moved, or made.",
          },
        ],
        photoBreakAfter: true,
      },
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Cleveland Avenue invests and accelerates from a Chicago base, founded by a former McDonald's chief executive, and it concentrates on food, beverage, consumer, and agricultural technology from seed through growth. Its climate relevance is adjacent rather than central, showing up in alternative protein and sustainable packaging rather than energy or industrial decarbonization. Suits food and beverage founders whose sustainability story sits inside a consumer business.",
          },
        ],
      },
    ],
        ...
        orgs: [
          {
            ...
            body: "The AMS Startup Booster is the incubator run by AMS Institute at Marineterrein, and it costs nothing and takes no equity, which is rare for a program of its quality. Over roughly five months, teams working on urban sustainability problems get coaching, validation support, access to the institute's living labs across the city, and a demo day in front of the Amsterdam ecosystem, with the research bench of TU Delft, Wageningen, and MIT behind it. Cohorts are selected through an open call. Suits early teams building for cities in energy, circularity, mobility, or climate adaptation who want structure without giving up equity.",
          },
          {
            ...
            body: "Amsterdam Circular is the investor-readiness program AMS Institute runs with the City of Amsterdam and Rockstart for circular-economy ventures. It is aimed at companies with traction that are not yet fundable, and it works on the specific difficulty of financing circular business models where value sits in materials, reuse, and long asset lives rather than in software margins. Suits circular-economy founders preparing for a first institutional raise.",
          },
        ],
      },
      {
        ...
        orgs: [
          ...
          },
          {
            ...
            body: "IXA is the shared knowledge transfer office for the University of Amsterdam, VU Amsterdam, the Amsterdam University of Applied Sciences, and Amsterdam UMC, which means a single door covers most of the city's research base. It handles patents, licensing, spinout formation, and grant applications, and it operates the incubation programs that sit downstream of that work, including the Demonstrator Lab. Suits Amsterdam-affiliated researchers who need to establish who owns what before they can raise.",
          },
          {
      ...
      },
      {
        ...
        orgs: [
          ...
          },
          {
            ...
            body: "IVM is VU Amsterdam's environmental research institute, covering climate risk, water, and environmental economics, and it is a research institute with no founder-facing program. Its value to a founder is expertise and collaboration, particularly on climate risk and water questions where Dutch research is genuinely world-leading, and the commercialization route runs through Demonstrator Lab and ACE Incubator. Suits founders looking for academic research partners on climate risk, adaptation, or water.",
          },
        ],
      },
      {
        ...
        orgs: [
          {
            ...
            body: "TNO is the Dutch applied research organization, and its venture arm creates spinouts and takes stakes in startups building on TNO technology across energy, industry, and materials, with the option for young companies to pay in shares rather than cash. TNO's principal sites are outside Amsterdam, so treat this as a national resource reachable from the city rather than a local one. Suits founders licensing or building on Dutch applied research in energy and industrial technology.",
          },
        ],
      },
    ],
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Impact Hub Amsterdam runs the city's longest-standing accelerator programming for impact ventures, with recurring cohorts in food systems and regenerative business alongside a co-working community and a route into the global Impact Hub network. Programs combine masterclasses, one-to-one mentoring, and a demo day, and it delivers several of the City of Amsterdam's own impact programs, which makes it the practical front door to municipal support. Suits circular-economy, food, and impact founders who want cohort programming and access to city programs.",
          },
          {
            ...
            type: "Incubator",
            focus: "Urban climate, circular & energy",
            body: "Cross-listed because it is the strongest incubator in the city for climate and urban ventures. Roughly five months of coaching, validation, and living-lab access at Marineterrein, at no cost and with no equity taken, ending in a demo day in front of the local ecosystem. Entry is by open call. Suits early urban climate teams who want structure and a first network without dilution.",
          },
          {
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Metabolic is the Amsterdam circular-economy firm that works as a consultancy, a think tank, and a venture builder at once, which means it both studies material flows for cities and starts companies to fix them. Its venture arm builds and co-founds ventures rather than investing in existing ones, and the group has been behind circular living labs in Amsterdam Noord and food-system venture studios, so what is on offer is co-creation rather than a cheque. Suits founders and prospective founders who want to build a circular venture with a partner rather than pitch one.",
          },
          {
            name: "Techleap",
        ...
        orgs: [
          {
            ...
            body: "The Port of Amsterdam is the industrial engine of the region's energy transition, historically built on petroleum handling and now positioning itself as a hydrogen and sustainable-fuels hub through a dedicated coalition and regional hydrogen infrastructure work. It offers founders demonstration sites, port-based pilots, and a launching-customer role, and it does not run a structured accelerator, so the route in is the coalition and the port's project teams rather than an application form. Suits hydrogen, fuels, and circular industry founders who need industrial-scale demonstration space.",
          },
          {
            ...
            body: "Alliander Corporate Ventures is the investment and venturing arm of the network group behind Liander, the distribution operator for Amsterdam and much of the surrounding region, and it is headquartered in Arnhem rather than the city. It invests directly and through joint ventures, and it can offer something scarcer than money, which is a grid operator willing to run a pilot at a time when Dutch connection queues have made flexibility, forecasting, and local energy management commercially urgent. Suits grid, flexibility, and energy-management founders who need a distribution operator as a partner.",
          },
          {
            ...
            body: "Royal Schiphol Group operates Amsterdam's airport from Haarlemmermeer, just outside the city, and European fuel blending rules have turned sustainable aviation fuel, emission-free ground handling, and airside electrification from ambition into obligation. It works with startups through external innovation platforms and supplier onboarding rather than an in-house accelerator, and it has run first-of-a-kind deployments in aircraft towing and waste recycling, so what it offers is a demanding first customer. Suits aviation fuel, ground-handling, and electrification founders ready for a hard operational pilot.",
          },
        ],
      },
    ],
    ...
    groups: [
      {
        orgs: [
          ...
          },
          {
            ...
            body: "Rubio Impact Ventures is an Amsterdam impact fund that ties its own economics to measured impact rather than reporting it after the fact, investing early across the climate crisis and social inequality. It backs companies in circular economy, food and health systems, and worker-centered models, and it has been doing so long enough to have a European track record and a backer list running from the European Investment Fund to Dutch institutions. Suits early-stage European founders whose impact is central to the business rather than adjacent to it.",
          },
          {
            name: "Pymwymic",
          ...
          },
          {
            ...
            body: "The ABN AMRO Sustainable Impact Fund is the bank's own balance-sheet impact investor, based in Amsterdam and investing in energy transition, the built environment, and sustainable consumption. It writes larger cheques into companies that already have revenue and a route to scale, with occasional smaller venture tickets, and it brings sector expertise plus the debt and corporate-finance capability of a large bank. It is a growth investor rather than a seed one. Suits founders past early revenue seeking growth equity with a strategic banking relationship.",
          },
          {
            name: "Invest-NL",
        ...
        orgs: [
          {
            ...
            body: "ROM InWest is the regional development company for North Holland, covering Amsterdam and its metropolitan area, investing through funds aimed at small and medium enterprises and at the energy and circular transitions. It writes early cheques, often alongside other regional and national investors, and pairs money with business developers who help companies navigate Dutch subsidy schemes and regional institutions. Suits early-stage energy and circular founders based in North Holland who want regional public capital.",
          },
          {
          ...
          },
          {
            ...
            body: "Curiosity is an Amsterdam pre-seed and seed investor in applied artificial intelligence software, and it names energy and climate technology among its focus areas alongside other verticals, covering smart grid, clean energy, solar, and battery software. It is a vertical software generalist rather than a climate specialist, which makes it a good fit for software-first climate founders and a poor one for hardware. Suits pre-seed climate software founders in the Benelux and Nordics.",
          },
        ],
      },
    ],
